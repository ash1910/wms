             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Modify Bill Date</h5>
                    </div>
				...
				<table id="example2" class="table table-bordered mb-0">
					<thead>
						<tr>
							...
							<th scope="col" style="border: 1px solid black;text-align: center;">Car Req. / Chassis  no</th>
...
$result = DB::select("
SELECT `bill_no`, a.customer_id, b.customer_nm, b.customer_mobile, b.customer_reg, `job_no`, `user_id`, 
`total` total ,bill_dt, job_dt, b.customer_vehicle
...
?>				
					<tr>
						...
						<td style="border: 1px solid black;text-align: center;"><a href="report02?bill={{$item->bill_no}}">{{$item->customer_nm}}</a></td>
						<td style="border: 1px solid black;text-align: center;"><a href="report02?bill={{$item->bill_no}}">{{$item->customer_reg}}</a></td>
						<td style="border: 1px solid black;text-align: center;"><a href="report02?bill={{$item->bill_no}}">{{$item->customer_vehicle}}</a></td>
					...
					<form style="display: inline;" action="ModifyBillDt01" method="post">{{ csrf_field() }}
