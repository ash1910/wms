...
$job_no_col = DB::select("SELECT `job_no` FROM `tbl_acc_details` WHERE `ref` = '$myRef';");

$my_Job_ref = $job_no_col [0]->job_no;
...
$rep_data_pur_details = DB::select("SELECT `id`,`prod_id`,`prod_name`,`gin`,`qty`,`req`,`avg_price`,`amount`,`job_no`,`note`,`dt` FROM `issue` WHERE `job_no` ='$my_Job_ref';");

$rep_data_sum = DB::select("SELECT SUM(qty) As qty, SUM(amount) AS amount FROM `issue` WHERE `job_no` ='$my_Job_ref';");
            ...
            <tbody>
                ...
                @foreach($rep_data_pur_details as $item)
                    ...
                    <tr>
                        ...
                        <td style="text-align:right" ><?php  echo number_format($item->avg_price) ?></td>
                ...
                <tr>
                    ...
                    <td>Amount (in word) : <?php  echo NumberintoWords($rep_data_sum[0]->amount); ?> only</td>
                    ...
                    <td></td>
                    @if(isset( $rep_data_sum ))
                        <td style="text-align:right"> <?php  echo number_format($rep_data_sum[0]->amount) ?> </td>
                    @endif
                    <td></td>
                    <td></td>
