...
<div class="divMid" style="margin-top: 280px;">

<div style="text-align: right;margin-right: 30px;"><b>Due Reference:</b> {{$ref}}</div>
...
<?php
	...
	sum(charge) charge, 
	sum(sales_return) sales_return,sum(advance_refund) advance_refund,
	sum(complementary_work) complementary_work, sum(rework) rework, sum(damage_work) damage_work
...
?>					<tr>
						...
						<td style="text-align: center;border: 1px solid black;">{{number_format(intval($item->unit_rate), 2, '.', ',')}}</td>
...
<td colspan="2" style="text-align: center;"><strong>Sub-Total</strong></td><td style="border: 1px solid black;text-align: right;"><strong> {{number_format(intval($subtotal), 2, '.', ',')}}</strong></td></tr>
...
?>					<tr>
		...
		if($row1=='46')
		{
				echo '<tr><td colspan="5" style="text-align: center;">Page 2 of 3</td></tr>';

			if($browser!='firefox')
			{
				echo '<tr><td style="height: 510px;"></td></tr>';
			}
			if($browser=='firefox')
			{
				
				echo '<tr><td style="height: 530px;"></td></tr>';
			}			
			?>
...
<tr><td colspan="2" style="border: 1px solid black;"></td>
<td colspan="2" style="border: 1px solid black;text-align: center;"><strong>Sub-Total</strong></td><td style="border: 1px solid black;text-align: right;"><strong> {{number_format(intval($subtotal01), 2, '.', ',')}}</strong></td></tr>

				
						<tr><td colspan="3" style="max-width: 200px;font-size: smaller;"><b>IN WORDS:</b> <?php 
						...
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Discount: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
							echo number_format(intval($discount+$vat_wav), 2, '.', ',');
							?></td>
							</strong></td>
						</tr>	
...
<?php if($sales_return>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>SR: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php if($advance_refund>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>AR: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php if($complementary_work>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>CW: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php if($rework>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Rework: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php if($damage_work>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>DW: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php } ?>						
						...
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Net Bill: </strong></td><td style="text-align: right;border-top: 1px solid black;"><strong>
							<?php 
							echo number_format(intval($total+$vat-$discount-$vat_wav), 2, '.', ',');
							?></td>
							</strong></td>
						</tr>
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Paid Tk.: </strong></td><td style="text-align: right;"><strong>
							<?php 
							echo number_format(intval($received+$charge), 2, '.', ',');
							?></td>
							</strong></td>
						</tr>
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Due : </strong></td><td style="text-align: right;"><strong>
							<?php 
							echo number_format(intval($due), 2, '.', ',');
							?></td>
							</strong></td>
						</tr>
