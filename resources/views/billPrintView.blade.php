...
<?php
	...
	sum(rework) rework, sum(damage_work) damage_work
...
<?php if($sales_return>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Sale RTN: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php if($complementary_work>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Comple. WK: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
<?php if($damage_work>0){ ?>						
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>Damage WK: </strong></td><td style="text-align: right;"><strong>
							-
							<?php 
...
{?>
                        <tr><td colspan="3" ></td>
							<td colspan="1" style="white-space: unset;"><strong>
...
<?php if($ait!='0'){ ?>
						<tr><td colspan="3" ></td>
							<td colspan="1"><strong>AIT Tk.: </strong></td><td style="text-align: right;"><strong>
							<?php 
