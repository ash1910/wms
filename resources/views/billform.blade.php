             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Create Bill/ Cash Memo</h5>
                    </div>
				...
				<div class="card-body">
					<div class="col-3">
					  <div class="">
						<!--small>to</small-->
						<address class="m-t-5 m-b-5">
						<form action="billcard" method="post"> {{ csrf_field() }}
						<table>
...
<?php } ?>
						   ...
						   <tr><td><strong class="text-inverse">Job No.: </strong></td><td><input name="job" type="text" maxlength="7" minlength="7" required></td></tr>
						...
						<tr><td>
<?php if(session('role')=="Service Engineer"){ ?>						
						<button class="btn btn-success" type="submit" name="register" value="register02">
						<i class="lni lni-chevron-right-circle"></i> Submit</button>
<?php } ?>						
<?php if(session('role')!="Service Engineer"){ ?>						
