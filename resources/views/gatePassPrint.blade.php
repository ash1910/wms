...
$result = DB::select("
SELECT a.`bill_no`, a.customer_id, a.customer_nm,customer_vehicle, b.customer_reg, 
a.`job_no`, a.`user_id`, `total` total ,bill_dt, b.customer_chas
...
?>				
					<tr>
						...
						<td style="border: 1px solid black;text-align: center;">{{$item->customer_chas}}</a></td>
