             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">From Date: {{date('d-M-Y', strtotime($from_dt))}}  To: {{date('d-M-Y', strtotime($to_dt))}} </h5>
                    </div>
...
$stock01 = DB::select("
SELECT bill_no,bill_mas.bill_dt bill_dt, bill_mas.job_no job_no,bill_mas.job_dt job_dt, 
...
?>					<tr>
						...
						<td style="text-align: center;">{{date('d-M-Y', strtotime($item->bill_dt))}}</td>
						...
						<td style="text-align: right;">{{number_format(($item->bill), 2, '.', ',')}}</td>
