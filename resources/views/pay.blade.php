...
<?php if($advance!="") {?>
                              <div class="d-flex align-items-center mb-3">
                                <div>
                                  <p class="mb-0">Advance Received </p>
                                </div>
                                <div class="ms-auto">
...
<?php } ?>							  
                              ...
                              <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ms-auto">
                                  TK. <input id="id-2" name="bonus" type="text" value='0' required>
                              </div>
                              </div>
                              <div class="d-flex align-items-center mb-3">
                                <div>
                                  <p class="mb-0">Vat Waiver</p>
                                </div>
                                <div class="ms-auto">
                                  TK. <input id="id-3" name="vat_wav"  value='0' type="text" required>
                              </div>
                              </div>
                              ...
                              <div class="d-flex align-items-center mb-3">
                                <div>
                                  <p class="mb-0">AIT Deduction</p>
                                </div>
                                <div class="ms-auto">
                                  TK. <input id="id-8" name="ait"  value='0' type="text" required>
                              </div>
                              </div>
                            <div class="d-flex align-items-center mb-3">
                              <div>
...
<label for="Due">
    <input value="due" type="radio" id="Due" name="pay_type" onclick="ShowHideDiv()" required/>
    Due
</label>
<label for="Online">
...
<div id="dvCheque" style="display: none">
	...
	<div class="d-flex align-items-center mb-3" style="width: 100%;">
	  ...
	  <div style="width: 70%;">
		<input type="text" name="chequeNo" style="width: 100%;" maxlength="20"/>
	  </div>
	</div>
	<div class="d-flex align-items-center mb-3" style="width: 100%;">
	  <div style="width: 30%;">
...
$(function () {
  $("#id-1, #id-2, #id-3, #id-8, #id-9").keyup(function () {
    $("#id-4").val(Math.round( {{$net_bill01}} - (+$("#id-1").val() + +$("#id-2").val()+ +$("#id-3").val()+ +$("#id-9").val()+ +$("#id-8").val())));
  });
});
...
$(function () {
  $("#id-1, #id-2, #id-3, #id-8").keyup(function () {
    $("#id-4").val(Math.round( {{$net_bill01}} - (+$("#id-1").val() + +$("#id-2").val()+ +$("#id-3").val()+ +$("#id-8").val()+ +$("#id-5").val())));
  });
});
</script>
<?php } ?>