...
<body>
	<div style="background-image: url(/assets/images/moneyReceiptBGAutosolution.jpg);
...
<tr>
	<td><b>Advance Receipt Amount</b>: Tk.{{number_format(intval($received), 2, '.', ',')}}
...
<img src="/assets/images/seal01Autosolution.png" style="width: 120px;
    position: absolute;
    bottom: 65px;
    right: 87px;" />
