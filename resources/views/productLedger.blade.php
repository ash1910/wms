...
<div class="card"  style="padding:20px">
	<div class="col-12 col-lg-5">
		<div class="card shadow-none border radius-15">
			<div class="card-body">
			<form class="row g-3" action="productLedger02" method='get' name="myForm" onsubmit="return validateForm()">
			{{ csrf_field() }}
			
				<table>
					<tr><td><strong class="text-inverse">Product: </strong></td>
						<td><input autofocus name="id" type="text" id="tags" required style="width: 100%;"></td>
