...
@endif				
	...
	<div class="card shadow-none border radius-15">
		<div class="card-body">
			<form class="row g-3" action="purchase01" method='post' name="myForm" onsubmit="return validateForm()">
			{{ csrf_field() }}
			
				<table>
					<tr><td><strong class="text-inverse">Supplier: </strong></td>
						<td><input autofocus name="supplier" type="text" id="tags" required></td></tr>
					<tr><td><strong class="text-inverse">Supplier's Bill No.: </strong></td><td><input required name="ref" type="text" ></td></tr>
					<tr><td><strong class="text-inverse">Date: </strong></td>
						<!--td><input name='dt' type="text" readonly id="datepicker" required></td></tr-->
						<td><input name='dt' type="date" class="form-control" required></td></tr>
