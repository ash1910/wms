                         ...
                         <div class="card-body">
                           <form action="purchaseReturn04" method="post" class="row g-3">{{ csrf_field() }}
							...
							<div class="col-12">
							  ...
							  <input disabled value="{{$amount}}" id="id-3" required type="text" class="form-control" placeholder="e.g.- 1">
                            </div>
							<div class="col-12">
                               <label class="form-label">Job No.</label>
                               <input disabled value="{{$job_no}}" required name="job_no" type="text" class="form-control" placeholder="e.g.- 1111-22" maxlength="7">
                            </div>
							<div class="col-12">
							...
							<input type="hidden" name="prod_name" value="{{$prod_name}}"></input>
							...
							<input type="hidden" name="job_no" value="{{$job_no}}"></input>
