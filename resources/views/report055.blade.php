              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Engineering Receivable</li>
                  </ol>
                </nav>
              </div>
             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Engineering Receivable Reports </h5>
                    </div>
...
$result = DB::select("
select bill_no,job_no,customer_nm,net_bill,received,bonus,due,vat_wav,bill_dt,charge,customer_reg,customer_vehicle, customer_id
from
(
...
<strong>Engineering Receivable Amount: Tk. {{number_format(($total02), 2, '.', ',')}}	</strong>
<br><br><br>
