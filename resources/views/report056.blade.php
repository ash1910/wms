              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Intercompany Receivable</li>
                  </ol>
                </nav>
              </div>
             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Intercompany Receivable Reports </h5>
                    </div>
...
$result = DB::select("
select bill_no,job_no,customer_id,customer_nm,net_bill,received,bonus,due,vat_wav,bill_dt,charge,customer_reg,customer_vehicle
from
(
SELECT `bill` bill_no, a.`job_no`, b.customer_nm, b.bill_dt,customer_reg,customer_vehicle,
sum(a.`net_bill`) net_bill, sum(`received`) received, sum(`bonus`) bonus, sum(`due`) due, sum(`vat_wav`) vat_wav, sum(charge) charge, b.customer_id
...
GROUP by bill,job_no,customer_id,customer_nm,b.bill_dt,customer_reg,customer_vehicle
)A
where due > 1
...
<strong>Intercompany Receivable Amount: Tk. {{number_format(($total02), 2, '.', ',')}}	</strong>
<br><br><br>
