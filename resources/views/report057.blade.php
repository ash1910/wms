              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Automobile Receivable</li>
                  </ol>
                </nav>
              </div>
             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Automobile Receivable Reports </h5>
                    </div>
...
<strong>Automobile Receivable Amount: Tk. {{number_format(($total02), 2, '.', ',')}}	</strong>
<br><br><br>
