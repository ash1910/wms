              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bkash</li>
                  </ol>
                </nav>
              </div>
             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Charges Report By Bkash [From Date: {{$from_dt}} To: {{$to_dt}}]</h5>
                    </div>
...
AND a.charge > 0 AND a.pay_type = 'bkash' 
...
<strong>Total Charge Amount: Tk. {{number_format(($total03), 2, '.', ',')}}	</strong><br>
