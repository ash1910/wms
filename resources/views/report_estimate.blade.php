             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Estimate Report [From Date: {{$from_dt}} To: {{$to_dt}}]</h5>
                    </div>
				...
				<table id="example2" class="table table-bordered mb-0">
					<thead>
						<tr>
							...
							<th scope="col" style="border: 1px solid black;text-align: center;">Est No</th>
							<th scope="col" style="border: 1px solid black;text-align: center;">Time Required</th>
...
$result = DB::select("
SELECT `est_dt`,`est_no`, a.work, a.customer_id, b.customer_nm, b.customer_mobile , b.customer_group , b.company , b.sister_companies, `days`, 
`user_id`, `net_bill` ,customer_reg,customer_chas,customer_vehicle, total, parts, service, engineer
FROM `est_mas` a, customer_info b
WHERE `est_dt` between '$from_dt' and '$to_dt'
...
?>					<tr>
						...
						<td style="border: 1px solid black;text-align: center;">{{$item->est_dt}}</td>
						...
						<td style="border: 1px solid black;text-align: center;">{{$item->days}} Working Days</td>
...
<strong>Total Estimate Amount: Tk. {{number_format(intval($total02), 2, '.', ',')}}	</strong>
<br><br><br>				
