              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">WIP Stock</li>
                  </ol>
                </nav>
              </div>
             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">WIP Stock Report </h5>
                    </div>
...
$stock01 = DB::select('
SELECT a.prod_id, a.prod_name, SUM(a.qty) AS stock_qty, SUM(a.amount) AS amount FROM issue a, bill_mas b WHERE a.job_no = b.job_no AND b.flag = 0 GROUP BY a.prod_id, a.prod_name ORDER BY a.prod_id;
');
	$sl = '1'; 	$total02 = '0';
