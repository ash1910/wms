             ...
             <div class="card-header py-3">
                  <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-12">
                      <h5 class="mb-0">Vehicle Ledger [Register Number: {{$reg}}]</h5>
                    </div>
...
SELECT `job_dt`,`bill_no`, a.customer_id, a.customer_nm, b.customer_mobile, a.`job_no`, 
...
group by `job_dt`,`bill_no`, a.customer_id, a.customer_nm, b.customer_mobile, a.`job_no`, 
a.`user_id`, a.`net_bill` ,customer_reg,customer_chas,customer_vehicle, total, parts, service,a.bill_dt
;
");
	$sl = '1'; 	$total02 = '0';		
